...
import { Home, FileText, Users, Phone, LogOut, Plug, FileSymlink } from 'lucide-react';
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const elementsNavigation = [
    ...
    { icon: <FileSymlink className="h-4 w-4" />, label: 'Templates', href: '/templates' },
    { icon: <Users className="h-4 w-4" />, label: 'Patients', href: '/patients' },
    { icon: <Phone className="h-4 w-4" />, label: 'Contacts', href: '/contacts' },
    { icon: <Plug className="h-4 w-4" />, label: 'Intégrations', href: '/integrations' },
  ];
