...
export function IntegrationCard({ 
  ...
  const renderStatusBadge = (status: IntegrationStatus) => {
    switch (status) {
      ...
      case 'coming_soon':
        return <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200">Bientôt disponible</Badge>;
      case 'not_available':
        return <Badge variant="outline" className="bg-gray-50 text-gray-700 border-gray-200">Pas encore disponible</Badge>;
      default:
        return null;
    }
  };
      ...
      <CardContent>
        ...
        {integration.isConnected && (
          <div className="flex items-center text-sm text-muted-foreground mt-2">
            ...
            <span>Dernière synchronisation : {formatDate(integration.lastSyncDate)}</span>
          </div>
        )}
      </CardContent>
